...
- panel: { id, x (cara exterior), facing?: \"right\" | \"left\" (hacia dónde mira la cara interior), y?, z?, depth?, height?, material?, joint? } — lateral suelto que sostiene una tapa (punta de escritorio sin cajonera); la tapa apoya en carcasas y laterales\n\
- modesty: { id, worktop?, height? (300), inset? (20, desde el fondo) } — faldón entre los apoyos de una tapa; sin él, una tapa sobre laterales se mueve (DESIGN-117)\n\
